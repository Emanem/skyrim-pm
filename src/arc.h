...
public:
		...
		bool extract_file(const std::string& fname, const std::string& tgt_filename, file_names* esp_list = 0);
		size_t extract_dir(const std::string& base_match, const std::string& base_outdir, file_names* esp_list = 0);
